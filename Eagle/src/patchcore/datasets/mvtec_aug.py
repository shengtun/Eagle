...
class MVTecDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        classname, anomaly, image_path, mask_path, aug_type = self.data_to_iterate[idx]
        ...
        #     elif aug_type == "v":
        #         image = F.vflip(image)
        if anomaly == "good" and aug_type == "h":
            image = F.hflip(image)
                ...
                for anomaly in sorted(imgpaths_per_class[classname].keys()):
                    for image_path in imgpaths_per_class[classname][anomaly]:
                        if not image_path.lower().endswith(image_extensions):
                            continue
                        if anomaly == "good":
                            for aug_type in ["none", "h"]:
                                data_to_iterate.append([classname, anomaly, image_path, None, aug_type])
                        else:
                            data_to_iterate.append([classname, anomaly, image_path, None, "none"])
                ...
                for anomaly in sorted(imgpaths_per_class[classname].keys()):
                    if anomaly == "good":
                        ...
                        for image_path in imgpaths_per_class[classname][anomaly]:
                            ...
                            data_to_iterate.append([classname, anomaly, image_path, mask_path, "none"])
