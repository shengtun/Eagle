...
from summary import caculate_accuracy
...
'''
instruction_P = '''
You are my industrial image inspection assistant. You will receive multiple images simultaneously, 
including a template image, a query image, and a query image with red bounding boxes. Based on the input images and the accompanying textual information, answer the given question. The question is multiple-choice. 
Respond only with the letter of the correct option (e.g., A, B, C, or D). Do not include explanations or extra text.
'''
        ...
        for key in text_gt.keys():
            ...
            if key.startswith(keyword):
                ...
                for i, QA in enumerate(conversation):
                    # peng: new parameters: type for select prompt
